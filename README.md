...
- **Switch:** Netgear L2
- **AP:** UniFi U7
- **Server:** RHEL 9 ejecutando Podman (UniFi Controller)

## 📁 Estructura del Repositorio
- `Archivos_Obsidian/`: Todas mis notas técnicas sincronizadas.
- `Laboratorio/`: Diagramas y configuraciones de mi red doméstica.
